...
[The Ansible docsite](https://docs.ansible.com/ansible/latest/collections/community/index.html) will refer to a collection's documentation within a day after the collection inclusion is done.
